...
CREATE TABLE `user` (
 ...
 INSERT INTO user (user_id, first_name, last_name, email, phone, dob, course, password , username) VALUES (0,"a", "n", "a@google.com", 040, "12/04/2020", "wooo", "12345678", "a");
INSERT INTO admin (u_id) VALUES (0);
INSERT INTO manager (u_id) VALUES (0);
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-01  0:54:40
